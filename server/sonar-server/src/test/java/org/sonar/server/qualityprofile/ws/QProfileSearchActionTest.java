...
public class QProfileSearchActionTest {
  ...
  public void setUp() throws Exception {
    ...
    tester = new WsTester(new QProfilesWs(
      ...
      new QProfileSearchAction(new Languages(xoo1, xoo2), profileLookup, profileService),
  ...
  public void search_nominal() throws Exception {
    ...
    when(profileService.getDefault(xoo1.getKey())).thenReturn(QualityProfileDto.createFor("sonar-way-xoo1-12345"));
  ...
  public void search_with_fields() throws Exception {
    ...
    when(profileService.getDefault(xoo1.getKey())).thenReturn(QualityProfileDto.createFor("sonar-way-xoo1-12345"));
    when(profileService.getDefault(xoo2.getKey())).thenReturn(QualityProfileDto.createFor("sonar-way-xoo2-23456"));
  ...
  public void search_for_language() throws Exception {
    ...
    when(profileService.getDefault(xoo1.getKey())).thenReturn(QualityProfileDto.createFor("other-profile-xoo1-12345"));
