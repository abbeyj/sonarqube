...
public class PersistFileSourcesStep implements ComputationStep {
  ...
  private void recursivelyProcessComponent(ComputationContext context, int componentRef) {
    ...
    List<BatchReport.Symbol> symbols = reportReader.readComponentSymbols(componentRef);
  ...
  private void processSymbols(BatchReport.Component component, List<BatchReport.Symbol> symbols) {
